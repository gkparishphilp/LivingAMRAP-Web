...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { description: @workout.description, name: @workout.name, timer_type: @workout.timer_type }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { description: @workout.description, name: @workout.name, timer_type: @workout.timer_type }
    assert_redirected_to workout_path(assigns(:workout))
  end
